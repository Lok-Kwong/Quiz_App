...
public class QuizDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_QUIZRESULTS =
            "create table " + TABLE_QUIZRESULTS + " ("
                    ...
                    + QUIZRESULTS_COLUMN_QUESTION1 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION1 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + QUIZRESULTS_COLUMN_QUESTION2 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION2 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + QUIZRESULTS_COLUMN_QUESTION3 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION3 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + QUIZRESULTS_COLUMN_QUESTION4 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION4 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + QUIZRESULTS_COLUMN_QUESTION5 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION5 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + QUIZRESULTS_COLUMN_QUESTION6 + " TEXT," + " FOREIGN KEY (" + QUIZRESULTS_COLUMN_QUESTION6 + " ) REFERENCES " + TABLE_QUIZQUESTIONS + " (" + QUIZQUESTIONS_COLUMN_ID + "), "
                    + ")";
